    ...
    <div className="bg-white">
      <div className={cn("relative mx-auto", isIndividual ? "max-w-[1480px]" : "w-full")}>
        ...
        <div className="flex relative">
          ...
          <aside className="hidden lg:flex w-[220px] shrink-0 flex-col pt-6 pb-6 pl-5 pr-2 lg:sticky lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto">
              {/* User block */}
                ...
                {(
                  isIndividual
                    ? [
                        ...
                        { href: "/main/loyalty", label: "Мои бонусы", icon: BadgePercent },
