...
type Tariff = { price: number; minDays: number; maxDays: number; name: string }
type Office = { code: string; name: string; address_full: string; work_time: string }
