...
/**
 * Keeps preference analytics reproducible from order snapshots. Product IDs
 * are stored for new lines and backfilled for historical lines by exact name.
 */
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  // Keep historical links and editorial metadata readable after rollback.
  await db.execute(sql`
