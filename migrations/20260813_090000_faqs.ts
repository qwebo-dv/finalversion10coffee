  ...
  await db.execute(sql`
    ...
    SELECT seed.question, seed.answer, 'published', 'manual'
      FROM (VALUES
        ...
        ('Что делать, если товар не подошёл?', 'Напишите нам на info@10coffee.ru или в мессенджер MAX +79184387060 и укажите номер заказа. Мы разберём обращение и подскажем порядок возврата.')
