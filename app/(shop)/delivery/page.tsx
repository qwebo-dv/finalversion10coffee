      ...
      <article className="mx-auto max-w-5xl px-5 py-16 lg:px-10 lg:py-24">
        ...
        <div className="mt-12 space-y-5">
          ...
          <section className="rounded-[28px] border border-black/[0.07] bg-white/70 p-7 sm:p-9">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-[#554b43]">
              <p>Заказ можно оплатить банковской картой онлайн через защищённую платёжную страницу YooKassa. Доступные способы оплаты отображаются при оформлении.</p>
          ...
          <section className="rounded-[28px] border border-black/[0.07] bg-white/70 p-7 sm:p-9">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-[#554b43]">
              ...
              <p>Для уточнения заказа используйте номер из письма-подтверждения. Телефон: <a href="tel:+79384537060" className="font-bold text-[#5b328a]">+7 (938) 453-70-60</a>, email: <a href="mailto:info@10coffee.ru" className="font-bold text-[#5b328a]">info@10coffee.ru</a>.</p>
            </div>
          </section>
          ...
          <section className="rounded-[28px] border border-black/[0.07] bg-white/70 p-7 sm:p-9">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7 text-[#554b43]">
              ...
              <p>Чтобы оформить обращение, напишите на info@10coffee.ru и укажите номер заказа, товар и причину обращения. Денежные средства возвращаются тем же способом, которым была произведена оплата, если иной способ не согласован сторонами.</p>
            </div>
          </section>
        </div>
      </article>
