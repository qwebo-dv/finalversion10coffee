        ...
        <section className={styles.content}>
          <div className={styles.layout}>
            <div className={styles.copy}>
              ...
              <p>
                Если сейчас нет подходящей открытой позиции, всё равно отправьте резюме и укажите желаемую
                должность. Мы сохраним отклик в кадровом резерве и свяжемся с вами, когда появится подходящая
                возможность.
              </p>
